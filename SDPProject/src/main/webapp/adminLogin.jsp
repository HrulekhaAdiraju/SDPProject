...
<body>
  ...
  <div class="container">
    ...
    <form action="/checkAdminLogin" method="post">
      ...
      <input type="text" name="a_name" class="form-control" placeholder="Enter Username" required>
      
      <label>Enter Password:</label>
      <input type="password" name="a_pwd" class="form-control" placeholder="Enter Password" required>
