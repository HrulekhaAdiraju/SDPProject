...
<head>
  ...
  <script>
    // Function to check age before form submission
    function validateDOB() {
      ...
      // If the age is less than 16, show an alert and return false
...
<body>
  ...
  <div class="container">
    ...
    <form action="/insertStudent" method="post" enctype="multipart/form-data" onsubmit="return validateDOB()">
      ...
      <input type="date" id="dob" name="dob" class="form-control" placeholder="You should be at least 16 years old" required>
